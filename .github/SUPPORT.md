# Getting help with ForwardsPackageWorkshop

Thanks for using ForwardsPackageWorkshop. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ForwardsPackageWorkshop/issues) to make sure the 
